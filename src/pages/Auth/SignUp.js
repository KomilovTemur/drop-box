  ...
  return (
    <>
      <div className="h-screen bg-slate-800 flex items-center justify-center">
        <div className="border shadow-2xl shadow-white bg-white rounded-lg py-9 px-4 max-w-xs w-full space-y-2">
          <div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="group w-full mx-auto flex justify-center items-center py-2 px-7 rounded border border-transparent text-sm font-medium text-white bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
