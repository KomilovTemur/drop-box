  ...
  return (
    <>
      <label className="ml-4">
        <div className="text-white rounded flex items-center w-full font-base bg-blue-400 hover:bg-stone-900 hover:text-white py-3 px-5 cursor-pointer">
                ...
                <div className="" key={file.id}>
                  <div className="text-center mb-4">
                    <h4
                      className={
                        file.error
                          ? "text-red-800 font-medium text-lg"
                          : "font-medium text-lg"
                      }
                    >
                      {file.error
                  ...
                  <div className="w-full bg-gray-200 rounded-full dark:bg-gray-700">
                    <div
                      className={`${
                        file.error ? "bg-red-800" : "bg-blue-600"
